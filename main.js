...
document.body.append(pointer);
function click() {
    var pointerPosition = pointer.getBoundingClientRect();
    var centerX = pointerPosition.left + pointerPosition.width / 2;
    var centerY = pointerPosition.top + pointerPosition.height / 2;
    var elementUnder = document.elementFromPoint(centerX, centerY);
    console.log(elementUnder);
}
// let left: number = pointer.offsetLeft;
// let top1: number = pointer.offsetTop;
var xOffset = pointer.offsetLeft;
var yOffset = pointer.offsetTop;
document.onkeydown = function (e) {
    ...
    pointer.style.transform = "translate(".concat(xOffset, "px, ").concat(yOffset, "px)");
};
